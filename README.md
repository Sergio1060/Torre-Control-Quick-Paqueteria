...
Tablero BI de servicios de entrega (KPIs, distribución por estado, CEDI, ciudad de destino y tendencia creados vs. finalizados), construido en HTML/CSS/JS puro — sin backend ni build step.
